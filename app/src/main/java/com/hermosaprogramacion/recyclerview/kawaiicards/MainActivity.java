package com.hermosaprogramacion.recyclerview.kawaiicards;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lManager = new LinearLayoutManager(this); //También es posible usar el manager GridLayoutManager para mostrar los ítems en forma de grilla automatizada.
